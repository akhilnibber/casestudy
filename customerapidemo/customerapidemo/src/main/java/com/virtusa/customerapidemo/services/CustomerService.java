...
import com.virtusa.customerapidemo.models.Appointment;
...
public class CustomerService {
	...
	//insert the customer
//	@Caching(
//			put= { @CachePut(value= "Customercache", key= "#customer.customerId") },
...
//	@Cacheable(value= "customerCache", key= "#customerId")
	...
	//select where by customerId
		...
		public List<Customer> getAllCustomers(Integer pageNo, Integer pageSize, String sortBy)
	    {
		 ...
		 {
			 ResponseEntity<String> response =restTemplate.exchange(serviceUrl+"/customer/{id}",HttpMethod.GET,null,String.class,id);
