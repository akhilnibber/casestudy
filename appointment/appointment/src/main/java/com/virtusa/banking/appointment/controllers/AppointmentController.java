...
public class AppointmentController {
	...
	//retrieval  by id
		...
		@CrossOrigin("*")
		@GetMapping("/appointments/rm/{rmid}")
		public ResponseEntity<?> findRMById(@PathVariable("rmid") long rmid)
		{ 
			List<Appointment> appointment=this.appointmentService.getAppointmentByrmId(rmid);;
		...
		public ResponseEntity<?> findAppointmentByCustomerId(@PathVariable("customerId") long customerId)
		{
			List<Appointment> appointment=this.appointmentService.getAppointmentByCustomerId(customerId);
			if(appointment.isEmpty())
			{
				return ResponseEntity.notFound().build();	
			}
